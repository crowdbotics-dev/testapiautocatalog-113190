...
## Project Structure
    ...
    ├── testapiautocatalog_113190  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113190`
...
2. Clone this repo and `cd testapiautocatalog_113190`
